...
From LIMR Require Import src.expressions src.header.
...
(*increase all debrujin indices >= fv by m in T*)
...
(*subst_local t m G L L' means L{G/t} = L', with m being the increasing factor*)
